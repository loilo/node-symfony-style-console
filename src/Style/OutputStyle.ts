...
import OutputInterface, { VERBOSITY_LEVEL, OutputOptions } from '../Output/OutputInterface'
import OutputFormatterInterface from '../Formatter/OutputFormatterInterface'
import TableCellInterface, { TableCellInput, TableRowInput } from '../Helper/TableCellInterface'
...
abstract class OutputStyle implements OutputInterface, StyleInterface {
   ...
   * {@inheritdoc}
   */
  public abstract table (headers: TableCellInput[] | TableCellInput[][], rows: TableRowInput[]): void
   ...
   * {@inheritdoc}
   */
  public abstract askHidden (question: string, validator?: (...args: any[]) => boolean): Promise<string>
   ...
   * {@inheritdoc}
   */
  public abstract choice (question: string, choices: StringHash, defaultValue?: string|number): Promise<string|number>
